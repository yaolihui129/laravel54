<ul class="nav navbar-nav navbar-left">
    <li><a class="blog-nav-item" href="{{asset('/posts')}}">首页</a></li>
    <li><a class="blog-nav-item" href="{{asset('/posts/create'}}">写文章</a></li>
    <li><a class="blog-nav-item" href="{{asset('/notices')}}">通知</a></li>
